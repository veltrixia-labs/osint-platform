...
export async function renderProStructuralBriefDetail(id: string, container: HTMLElement, onBack: () => void) {
    ...
    try {
        ...
        container.innerHTML = `
            <div class="pro-brief-detail ${domainClass}">
