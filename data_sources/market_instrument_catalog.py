...
MARKET_INSTRUMENT_DEFINITIONS = [
    ...
    {"symbol": "USO", "name": "United States Oil Fund LP", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["energy_resource_risk"]},
    {"symbol": "IYT", "name": "iShares US Transportation ETF", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["supply_chain_intelligence"]},
    ...
    {"symbol": "EWG", "name": "iShares MSCI Germany ETF", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["energy_resource_risk"]},
    
    # Global / Macro
    {"symbol": "SPY", "name": "SPDR S&P 500 ETF Trust", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["global_market_intelligence"]},
    {"symbol": "QQQ", "name": "Invesco QQQ Trust", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["ai_semiconductor_intelligence"]},
    {"symbol": "IWM", "name": "iShares Russell 2000 ETF", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["global_market_intelligence"]},
    {"symbol": "TLT", "name": "iShares 20+ Year Treasury Bond ETF", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["global_market_intelligence"]},
    ...
    # Supply Chain
    {"symbol": "XLI", "name": "Industrial Select Sector SPDR Fund", "asset_class": "equity", "provider": "alpha_vantage", "domain_ids": ["supply_chain_intelligence"]},
    ...
    {"symbol": "USDEUR", "name": "USD / EUR", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["energy_resource_risk", "global_market_intelligence"], "base_currency": "USD", "quote_currency": "EUR"},
    {"symbol": "USDGBP", "name": "USD / GBP", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["global_market_intelligence"], "base_currency": "USD", "quote_currency": "GBP"},
    {"symbol": "USDCNY", "name": "USD / CNY", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["supply_chain_intelligence"], "base_currency": "USD", "quote_currency": "CNY"},
    {"symbol": "USDAUD", "name": "USD / AUD", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["global_market_intelligence"], "base_currency": "USD", "quote_currency": "AUD"},
    {"symbol": "USDKRW", "name": "USD / KRW", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["ai_semiconductor_intelligence", "supply_chain_intelligence"], "base_currency": "USD", "quote_currency": "KRW"},
    {"symbol": "USDSGD", "name": "USD / SGD", "asset_class": "fx", "provider": "frankfurter", "domain_ids": ["supply_chain_intelligence"], "base_currency": "USD", "quote_currency": "SGD"},
]
