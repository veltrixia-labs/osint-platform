...
_LLM_TOPIC_SYSTEM_PROMPT = (
    ...
    "- global_market_intelligence: DIRECT market/macro events ONLY — major index "
    "moves, central-bank policy decisions, inflation/GDP/jobs releases, recession or "
    "sovereign-debt signals. NOT general/cultural/human-interest/science/sports/crime "
    "news that merely mentions a country, a company, or 'the economy'.\n"
    ...
    "strategic bearing is none). If an article does not CLEARLY belong to a strategic "
    "domain's real subject, return none — do NOT default to global_market_intelligence. "
    "General news, human-interest, culture, sports, science, obituaries, crime, museums, "
    "travel, charities, and routine domestic politics are none. When unsure, answer none. "
    "Do NOT force-fit.\n"
